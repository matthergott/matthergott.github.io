...
import blackHorse from "../../golfCourses/blackHorse";
import metro from "../../golfCourses/metro";
import shoreline from "../../golfCourses/shoreline";
import diablo from "../../golfCourses/diablo";
import graysCrossing from "../../golfCourses/graysCrossing";
import oldGreenwood from "../../golfCourses/oldGreenwood";
import linksOfGlenEagles from "../../golfCourses/linksOfGlenEagles";
import silveradoNorth from "../../golfCourses/silveradoNorth";
import granite from "../../golfCourses/granite";
import delMonte from "../../golfCourses/delMonte";
import coricaSouth from "../../golfCourses/coricaSouth";
import baylands from "../../golfCourses/baylands";
import countryClubOfColumbus from "../../golfCourses/countryClubOfColumbus";
import greenIsland from "../../golfCourses/greenIsland";
import bullCreek from "../../golfCourses/bullCreek";
import jacaranda from "../../golfCourses/jacaranda";
...
const GolfMap = (props) => {
    ...
    window.initMap = () => {
        ...
        granite.init(map);
        greenIsland.init(map);
        graysCrossing.init(map);
        greySilo.init(map);
        halfMoon.init(map);
